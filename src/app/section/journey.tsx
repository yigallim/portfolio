...
const JourneyNode = ({
  ...
  return (
    <div className="flex max-md:flex-col text-white max-md:space-y-xs md:space-x-xl">
      ...
      <div className="flex-1">
        ...
        <div className="flex flex-wrap gap-2xs">
          {tags.map((tag, index) => (
            <JorneyTag key={index}>{tag}</JorneyTag>
          ))}
        </div>
      </div>
    </div>
...
const Journey = () => {
  return (
    <section id="journey" className="section-spacing overflow-hidden">
